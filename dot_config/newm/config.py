...
outputs = [
	##-- Laptop Display
    { 'name': 'eDP-1', 'scale': 2.0, 'pos_x': 0, 'pos_y': 0 , 'anim': True },
...
def app_rules(view):
    ...
    if view.app_id == "wlogout":
        ...
        return { "float": True, "float_size": (1600, 1080) }
